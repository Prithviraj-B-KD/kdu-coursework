...
public class Main {
   ...
   public static void  main (String[] args) {
      ...
      Coin coin = Market.getMarket_instance().findCoinByName("BTC").orElse(null);
      if (coin != null) {
      ...
      Market.getMarket_instance().getTopNCoins(10);
      Trader trader = Market.getMarket_instance().findTraderByName("james").orElse(null);
      if(trader!=null){
         trader.printPortfolio();
      } else {
         LogBack.infoLogger("Trader Not Found");
      }
      Trader trader2 = Market.getMarket_instance().findTraderByName("james").orElse(null);
      if(trader!=null){
      ...
      Trader trader1 = Market.getMarket_instance().findTraderByName("james").orElse(null);
      if(trader !=null){
         Double profitOrLoss = trader1.getTotalProfitLoss();
         if (profitOrLoss < 0){
      ...
      if(trader !=null){
         Double profitOrLoss = trader2.getTotalProfitLoss();
         if (profitOrLoss < 0){
            String loss = String.format("Loss : %.2f",profitOrLoss);
            LogBack.infoLogger(loss);
         } else {
