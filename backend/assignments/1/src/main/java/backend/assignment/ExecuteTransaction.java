...
public class ExecuteTransaction implements Runnable{
    ...
    ExecuteTransaction(){};
    ExecuteTransaction(JsonNode inputTransaction) {
        ...
        switch (type){
            case "BUY":
                ...
                transaction = new BuyTransaction(buyVolume,buyWalletNumber);
                break;
            case "SELL":
